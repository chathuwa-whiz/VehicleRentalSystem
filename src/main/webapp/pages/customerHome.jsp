            ...
            <div class="row">
                <div class="col-xl-4 col-md-4 mb-30">
                    <div class="single-cta">
                        ...
                        <div class="cta-text">
                            <h4>Find us</h4>
                            <span>1010 Pittugala, Malabe</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4 mb-30">
                ...
                <div class="col-xl-4 col-lg-4 mb-50">
                    <div class="footer-widget">
                        <div class="footer-logo">
                            <a href="#"><img src="https://cdn-icons-png.flaticon.com/512/2389/2389215.png" class="img-fluid" alt="logo"></a>
                        </div>
                        <div class="footer-text">
                            <p>Autolanka 2024. Your hassle-free car rental.</p>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 text-center text-lg-left">
                    <div class="copyright-text">
                        <p>Copyright &copy; 2024, All Right Reserved <a href="#">autolanka</a></p>
                    </div>
                </div>
